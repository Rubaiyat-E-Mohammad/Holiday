...
public class TopPlacesController extends RecyclerView.Adapter<TopPlacesController.TopPlacesViewHolder> {

    Context context;
    List<TopPlacesData> topPlacesDataList;

    public TopPlacesController(Context context, List<TopPlacesData> topPlacesDataList) {
